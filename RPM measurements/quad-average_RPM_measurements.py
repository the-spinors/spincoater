...
periods = [mean([bound_voltage_seconds[i - 1] - bound_voltage_seconds[i - 2], bound_voltage_seconds[i] - bound_voltage_seconds[i - 1], bound_voltage_seconds[i + 1] - bound_voltage_seconds[i], bound_voltage_seconds[i + 2] - bound_voltage_seconds[i + 1]]) for i in range(2, len(bound_voltage_seconds) - 2)]
